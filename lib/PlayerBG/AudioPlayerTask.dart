...
class AudioPlayerTask extends BackgroundAudioTask {
  ...
  void onPlayFromMediaId(String mediaId) async {
    // onPlay();
    int offset = 0;
    _queue.asMap().forEach((index, e) => {if (e.id == mediaId) offset = index});

    int skipOffset = offset - _queueIndex;
    print("OnPlayFromMediaId $skipOffset");
    skip(skipOffset);
  }
